...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-pink navbar-navy">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    <label>Tanggal</label>
                    <label class="form-control form-control-lg text-pink"><?= date('d M Y') ?></label>
                </div>
                </div>
                ...
                <div class="form-group">
                    <label>Jam</label>
                    <label class="form-control form-control-lg text-pink" id="jam"></label>
                </div>
                </div>
          ...
          <div class="col-lg-5">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-navy color-palette text-right">
                  <label class="display-4 text-pink">Rp. <?= number_format($grand_total,0) ?>.-</h1>
              </div>
            </div>
          </div>
  ...
  <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-navy color-palette text-center">
                  <h1 class=" text-pink" id="terbilang"></h1>
              </div>
            </div>
          </div>
